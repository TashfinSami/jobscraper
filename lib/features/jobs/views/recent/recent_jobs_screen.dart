  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: TAppBar(
        ...
        showBackArrow: true,
        padding: const EdgeInsets.only(left: TSizes.md, right: TSizes.lg, top: TSizes.md),
      ),
      body: Padding(
              ...
              () => Expanded(
                child: SingleChildScrollView(
                  child: ListView.separated(
                    itemCount: viewedController.viewedJobs.length,
                    shrinkWrap: true,
                    reverse: true,
                    padding: const EdgeInsets.only(top: TSizes.md, bottom: TSizes.spaceBtwItems),
                    physics: const NeverScrollableScrollPhysics(),
                    separatorBuilder: (BuildContext context, int index) {
                      return const SizedBox(height: TSizes.spaceBtwItems);
                    },
                    itemBuilder: (BuildContext context, int index) {
                      var job = viewedController.viewedJobs[index];
                      return Dismissible(
                        key: Key(job.jobId!),
                        ...
                        onDismissed: (direction) => viewedController.removeViewedJobsFromStorage(job),
